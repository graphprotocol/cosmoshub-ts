...
export class Commission {
  static encode(message: Commission, writer: Writer): void {
    const commission_rates = message.commission_rates;
    if (commission_rates !== null) {
      writer.uint32(10);
      writer.fork();
      CommissionRates.encode(commission_rates, writer);
      writer.ldelim();
    }

    const update_time = message.update_time;
    if (update_time !== null) {
      writer.uint32(18);
      writer.fork();
      google.protobuf.Timestamp.encode(update_time, writer);
      writer.ldelim();
    }
  }
...
export class Validator {
  static encode(message: Validator, writer: Writer): void {
    ...
    const consensus_pubkey = message.consensus_pubkey;
    if (consensus_pubkey !== null) {
      writer.uint32(18);
      writer.fork();
      google.protobuf.Any.encode(consensus_pubkey, writer);
      writer.ldelim();
    }
    ...
    const unbonding_time = message.unbonding_time;
    if (unbonding_time !== null) {
      writer.uint32(74);
      writer.fork();
      google.protobuf.Timestamp.encode(unbonding_time, writer);
      writer.ldelim();
    }
...
export class Params {
  static encode(message: Params, writer: Writer): void {
    ...
    if (unbonding_time !== null) {
      writer.uint32(10);
      writer.fork();
      google.protobuf.Duration.encode(unbonding_time, writer);
      writer.ldelim();
    }
...
export class RedelegationEntryResponse {
  static encode(message: RedelegationEntryResponse, writer: Writer): void {
    const redelegation_entry = message.redelegation_entry;
    if (redelegation_entry !== null) {
      writer.uint32(10);
      writer.fork();
      RedelegationEntry.encode(redelegation_entry, writer);
      writer.ldelim();
    }
