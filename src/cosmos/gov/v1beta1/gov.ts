...
export class Proposal {
  static encode(message: Proposal, writer: Writer): void {
    ...
    const final_tally_result = message.final_tally_result;
    if (final_tally_result !== null) {
      writer.uint32(34);
      writer.fork();
      TallyResult.encode(final_tally_result, writer);
      writer.ldelim();
    }

    const submit_time = message.submit_time;
    if (submit_time !== null) {
      writer.uint32(42);
      writer.fork();
      google.protobuf.Timestamp.encode(submit_time, writer);
      writer.ldelim();
    }

    const deposit_end_time = message.deposit_end_time;
    if (deposit_end_time !== null) {
      writer.uint32(50);
      writer.fork();
      google.protobuf.Timestamp.encode(deposit_end_time, writer);
      writer.ldelim();
    }

    const total_deposit = message.total_deposit;
    for (let i = 0; i < total_deposit.length; ++i) {
      writer.uint32(58);
      writer.fork();
      base.v1beta1.Coin.encode(total_deposit[i], writer);
      writer.ldelim();
    }

    const voting_start_time = message.voting_start_time;
    if (voting_start_time !== null) {
      writer.uint32(66);
      writer.fork();
      google.protobuf.Timestamp.encode(voting_start_time, writer);
      writer.ldelim();
    }

    const voting_end_time = message.voting_end_time;
    if (voting_end_time !== null) {
      writer.uint32(74);
      writer.fork();
      google.protobuf.Timestamp.encode(voting_end_time, writer);
      writer.ldelim();
    }
  }
...
export class DepositParams {
  static encode(message: DepositParams, writer: Writer): void {
    const min_deposit = message.min_deposit;
    for (let i = 0; i < min_deposit.length; ++i) {
      writer.uint32(10);
      writer.fork();
      base.v1beta1.Coin.encode(min_deposit[i], writer);
      writer.ldelim();
    }

    const max_deposit_period = message.max_deposit_period;
    if (max_deposit_period !== null) {
      writer.uint32(18);
      writer.fork();
      google.protobuf.Duration.encode(max_deposit_period, writer);
      writer.ldelim();
    }
  }
...
export class VotingParams {
  static encode(message: VotingParams, writer: Writer): void {
    const voting_period = message.voting_period;
    if (voting_period !== null) {
      writer.uint32(10);
      writer.fork();
      google.protobuf.Duration.encode(voting_period, writer);
      writer.ldelim();
    }
  }
