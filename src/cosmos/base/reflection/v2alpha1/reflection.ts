...
export class AppDescriptor {
  static encode(message: AppDescriptor, writer: Writer): void {
    ...
    if (query_services !== null) {
      writer.uint32(42);
      writer.fork();
      QueryServicesDescriptor.encode(query_services, writer);
      writer.ldelim();
    }
...
export class AuthnDescriptor {
  static encode(message: AuthnDescriptor, writer: Writer): void {
    ...
    for (let i = 0; i < sign_modes.length; ++i) {
      writer.uint32(10);
      writer.fork();
      SigningModeDescriptor.encode(sign_modes[i], writer);
      writer.ldelim();
    }
  }
...
export class InterfaceDescriptor {
  static encode(message: InterfaceDescriptor, writer: Writer): void {
    ...
    const interface_accepting_messages = message.interface_accepting_messages;
    for (let i = 0; i < interface_accepting_messages.length; ++i) {
      writer.uint32(18);
      writer.fork();
      InterfaceAcceptingMessageDescriptor.encode(interface_accepting_messages[i], writer);
      writer.ldelim();
    }
    ...
    for (let i = 0; i < interface_implementers.length; ++i) {
      writer.uint32(26);
      writer.fork();
      InterfaceImplementerDescriptor.encode(interface_implementers[i], writer);
      writer.ldelim();
    }
  }
...
export class QueryServicesDescriptor {
  static encode(message: QueryServicesDescriptor, writer: Writer): void {
    ...
    for (let i = 0; i < query_services.length; ++i) {
      writer.uint32(10);
      writer.fork();
      QueryServiceDescriptor.encode(query_services[i], writer);
      writer.ldelim();
    }
  }
