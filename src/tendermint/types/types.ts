...
export class BlockID {
  static encode(message: BlockID, writer: Writer): void {
    ...
    if (part_set_header !== null) {
      writer.uint32(18);
      writer.fork();
      PartSetHeader.encode(part_set_header, writer);
      writer.ldelim();
    }
  }
...
export class Header {
  static encode(message: Header, writer: Writer): void {
    ...
    if (last_block_id !== null) {
      writer.uint32(42);
      writer.fork();
      BlockID.encode(last_block_id, writer);
      writer.ldelim();
    }
...
export class Vote {
  static encode(message: Vote, writer: Writer): void {
    ...
    if (block_id !== null) {
      writer.uint32(34);
      writer.fork();
      BlockID.encode(block_id, writer);
      writer.ldelim();
    }
...
export class LightBlock {
  static encode(message: LightBlock, writer: Writer): void {
    ...
    if (signed_header !== null) {
      writer.uint32(10);
      writer.fork();
      SignedHeader.encode(signed_header, writer);
      writer.ldelim();
    }
    ...
    if (validator_set !== null) {
      writer.uint32(18);
      writer.fork();
      ValidatorSet.encode(validator_set, writer);
      writer.ldelim();
    }
  }
